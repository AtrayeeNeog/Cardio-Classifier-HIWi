...
SequentialForward <-function(){
  ...
  lrn = makeFeatSelWrapper(model, resampling = rdesc,
                           control =  makeFeatSelControlSequential(method = "sfs", alpha = 0.02), show.info = TRUE, measures = kappa)
...
SequentialBackward <-function(){
  ...
  rdesc = makeResampleDesc("CV", iters = 10)
  lrn = makeFeatSelWrapper(model, resampling = rdesc,
                           control =  makeFeatSelControlSequential(method = "sbs", alpha = 0.02), show.info = TRUE, measures = kappa)
