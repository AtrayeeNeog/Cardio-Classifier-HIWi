...
Chi-Squared <- function(){
  ...
  new_data$pathology <- factor(dtr$pathology)
  ncol(new_data)
  write.csv(new_data, file= "Data/Features-With-Chi-Squared-FS-Old.csv", row.names = FALSE)
...
Info_Gain <- function(){
  ...
  new_data$pathology <- factor(dtr$pathology)
  ncol(new_data)
  write.csv(new_data, file= "Data/Features-With-InfoGain-FS-Old.csv", row.names = FALSE)
...
Sequential_Forward <- function(){
  ...
  new_data$pathology <- factor(dtr$pathology)
  ncol(new_data)
  write.csv(new_data, file= "Data/Features-With-SequentialForward-Algorithm-FS-Old.csv", row.names = FALSE)
...
Sequential_Backward <- function(){
  ...
  new_data$pathology <- factor(dtr$pathology)
  ncol(new_data)
  write.csv(new_data, file= "Data/Features-With-SequentialBackward-Algorithm-FS-Old.csv", row.names = FALSE)
...
Genetic <- function(){
  ...
  new_data$pathology <- factor(dtr$pathology)
  ncol(new_data)
  write.csv(new_data, file= "Data/Features-With-GeneticAlgorithm-Old.csv", row.names = FALSE)
}
...
Random <- function(){
  ...
  new_data$pathology <- factor(dtr$pathology)
  ncol(new_data)
  write.csv(new_data, file= "Data/Features-With-Random-Algorithm-FS-Old.csv", row.names = FALSE)
...
CorFS <- function(){
  ...
  new_data$pathology <- factor(dtr$pathology)
  ncol(new_data)
  write.csv(new_data, file= "Data/Features-With-Correlational-FS-Old.csv", row.names = FALSE)
  
  
}

## Features which might be responsible for the misclassification of the Old Healthy patients as BAV.

df1 <- readr::read_csv(here::here("Data","Features-With-Correlational-FS-Old.csv"))
df2 <- readr::read_csv(here::here("Data","Features-With-SequentialBackward-Algorithm-FS-Old.csv"))
df3 <- readr::read_csv(here::here("Data","Features-With-GeneticAlgorithm-Old.csv"))

common1 <- intersect(colnames(df1), colnames(df2))
common <- intersect(colnames(df3),common1)
common
